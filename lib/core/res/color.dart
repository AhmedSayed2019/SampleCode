...
const statusBarColor = scaffoldBackgroundColor;
...
// fab
const floatingActionButtonColor = primaryColor;
const floatingActionButtonColorDark = statusBarColorDark;


// app
const appRateActive = Color(0xffFFD500);
const appRateInActive = hintColor;
...
// primary color
const primaryColor =  Color(0xff1DBF73);
// const primaryColorDark =Color(0xffCE202F);
const primaryColorDark =Color(0xff1DBF73);
const primaryColorLight =Color(0xffFEF7F7);
...
const grayColor = Color(0xFF777777);
// const highLiteColor = Color(0xFFF2F2F2);
const secondHighLiteColor = Color(0xFFFEF7F7);
const hintColor = Color(0xFF696F79);
const hoverColor  = Color(0xFFE6EAEF);
