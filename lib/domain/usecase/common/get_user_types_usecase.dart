...
class GetUserTypesUseCase  implements BaseUseCase<List<DependencyEntity>>{

  final SettingRepository _repository;

  const GetUserTypesUseCase({
  ...
  ResponseModel<List<DependencyEntity>> onConvert(BaseModel baseModel) {
    ...
    baseModel.responseData['types'].forEach((item) => list.add(DependencyModel.fromJson(item)));
