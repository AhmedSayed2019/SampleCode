...
class GetServicesUseCase  implements BaseUseCase<List<ServiceEntity>>{
  ...
  Future<ResponseModel<List<ServiceEntity>>> call() async =>
      BaseUseCaseCall.onGetData<List<ServiceEntity>>( await _repository.getServices(), onConvert);
