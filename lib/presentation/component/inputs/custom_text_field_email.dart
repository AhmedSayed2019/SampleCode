...
class CustomTextFieldEmail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomTextField(
      ...
      // startWidget:SizedBox(height: 18.r,width: 18.r,child: Center(child:CustomSVGIcon(Assets.fieldIconEmailIcon,color: Theme.of(context).primaryColor)  )),
      ...
      label: label??tr(LocaleKeys.email),
