...
class _CustomTextFieldPasswordState extends State<CustomTextFieldPassword> {
  ...
  Widget build(BuildContext context) {
    return CustomTextField(
      ...
      prefixWidget: widget.suffixData,
      // startWidget:SizedBox(height: 18.r,width: 18.r,child: Center(child:CustomSVGIcon(Assets.fieldIconPasswordIcon,color: Theme.of(context).primaryColor)  )),
      ...
      label: widget.label??tr(LocaleKeys.password),
