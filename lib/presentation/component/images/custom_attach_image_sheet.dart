...
class CustomAttachImage extends StatefulWidget {
  final ValueChanged<String> _onAttachImage;


  @override
  State<CustomAttachImage> createState() => _CustomAttachImageState();

  const CustomAttachImage({Key? key,
    required ValueChanged<String> onAttachImage,
  }) : _onAttachImage = onAttachImage, super(key: key);
}

class _CustomAttachImageState extends State<CustomAttachImage> {
...
showSelectAttachImageMethod(BuildContext context,{ required ValueChanged<String> onAttachImage}){
  ...
  showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return CustomAttachImage(onAttachImage: onAttachImage);
      });
}